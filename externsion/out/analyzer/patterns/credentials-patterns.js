...
exports.credentialsPatterns = exports.authPatterns = exports.tokenPatterns = exports.secretPatterns = exports.apiKeyPatterns = exports.passwordPatterns = void 0;
const types_1 = require("./types");
/**
 * Password patterns - detects password fields
 */
exports.passwordPatterns = (0, types_1.createPattern)('credentials-password', 'Password', 'credentials', [
    /^pass(word)?$/i,
 ...
 */
exports.apiKeyPatterns = (0, types_1.createPattern)('credentials-apikey', 'API Key', 'credentials', [
    /^api[-_]?key$/i,
 ...
 */
exports.secretPatterns = (0, types_1.createPattern)('credentials-secret', 'Secret', 'credentials', [
    /^secret$/i,
 ...
 */
exports.tokenPatterns = (0, types_1.createPattern)('credentials-token', 'Authentication Token', 'credentials', [
    /^token$/i,
 ...
 */
exports.authPatterns = (0, types_1.createPattern)('credentials-auth', 'Authentication Credential', 'credentials', [
 ...
 */
exports.credentialsPatterns = [
    exports.passwordPatterns,
    exports.apiKeyPatterns,
    exports.secretPatterns,
    exports.tokenPatterns,
    exports.authPatterns,
];
//# sourceMappingURL=credentials-patterns.js.map