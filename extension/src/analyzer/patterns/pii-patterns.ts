 ...
 */
export const namePatterns: MaskingPattern = createPattern(
  'pii-name',
  'Personal Name',
  'pii',
  [
 ...
 */
export const emailPatterns: MaskingPattern = createPattern(
  'pii-email',
  'Email Address',
  'pii',
  [
 ...
 */
export const phonePatterns: MaskingPattern = createPattern(
  'pii-phone',
  'Phone Number',
  'pii',
  [
 ...
 */
export const addressPatterns: MaskingPattern = createPattern(
  'pii-address',
  'Physical Address',
  'pii',
  [
 ...
 */
export const dateOfBirthPatterns: MaskingPattern = createPattern(
  'pii-dob',
  'Date of Birth',
  'pii',
  [
 ...
 */
export const ssnPatterns: MaskingPattern = createPattern(
  'pii-ssn',
 ...
 */
export const piiPatterns: MaskingPattern[] = [
  namePatterns,
  emailPatterns,
  phonePatterns,
  addressPatterns,
