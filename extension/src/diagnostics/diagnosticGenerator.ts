...
import { SensitivePattern, PatternCategory, DIAGNOSTIC_CODES } from '../patterns/types';
...
export class DiagnosticGenerator {
  ...
  createFieldDiagnostic(
    ...
    const diagnosticCode = DIAGNOSTIC_CODES[pattern.category];
    ...
    diagnostic.relatedInformation = [
      new vscode.DiagnosticRelatedInformation(
        ...
        `${categoryLabel} data should be protected to comply with ${complianceList}`
      )
    ];
  ...
  createLoggingDiagnostic(
    ...
    diagnostic.relatedInformation = [
      new vscode.DiagnosticRelatedInformation(
        ...
        `${categoryLabel} data should be masked before logging to prevent data leaks`
      )
    ];
