...
exports.healthPatterns = exports.geneticPatterns = exports.labResultPatterns = exports.healthInsurancePatterns = exports.treatmentPatterns = exports.diagnosisPatterns = exports.medicalRecordPatterns = void 0;
const types_1 = require("./types");
/**
 * Medical record patterns - detects medical record number fields
 */
exports.medicalRecordPatterns = (0, types_1.createPattern)('health-medicalrecord', 'Medical Record Number', 'health', [
 ...
 */
exports.diagnosisPatterns = (0, types_1.createPattern)('health-diagnosis', 'Medical Diagnosis', 'health', [
    /^diagnosis$/i,
 ...
 */
exports.treatmentPatterns = (0, types_1.createPattern)('health-treatment', 'Medical Treatment', 'health', [
    /^treatment$/i,
 ...
 */
exports.healthInsurancePatterns = (0, types_1.createPattern)('health-insurance', 'Health Insurance Information', 'health', [
 ...
 */
exports.labResultPatterns = (0, types_1.createPattern)('health-labresult', 'Laboratory Results', 'health', [
 ...
 */
exports.geneticPatterns = (0, types_1.createPattern)('health-genetic', 'Genetic/Biometric Data', 'health', [
 ...
 */
exports.healthPatterns = [
    exports.medicalRecordPatterns,
    exports.diagnosisPatterns,
    exports.treatmentPatterns,
    exports.healthInsurancePatterns,
    exports.labResultPatterns,
    exports.geneticPatterns,
];
//# sourceMappingURL=health-patterns.js.map