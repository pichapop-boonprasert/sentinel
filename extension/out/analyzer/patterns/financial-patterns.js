...
exports.financialPatterns = exports.taxIdPatterns = exports.paymentPatterns = exports.bankAccountPatterns = exports.cvvPatterns = exports.creditCardPatterns = void 0;
const types_1 = require("./types");
/**
 * Credit card patterns - detects credit card number fields
 */
exports.creditCardPatterns = (0, types_1.createPattern)('financial-creditcard', 'Credit Card Number', 'financial', [
 ...
 */
exports.cvvPatterns = (0, types_1.createPattern)('financial-cvv', 'Card Security Code', 'financial', [
    /^cvv$/i,
    /^cvc$/i,
 ...
 */
exports.bankAccountPatterns = (0, types_1.createPattern)('financial-bankaccount', 'Bank Account Number', 'financial', [
    /^bank[-_]?account$/i,
 ...
 */
exports.paymentPatterns = (0, types_1.createPattern)('financial-payment', 'Payment Information', 'financial', [
 ...
 */
exports.taxIdPatterns = (0, types_1.createPattern)('financial-taxid', 'Tax Identification', 'financial', [
 ...
 */
exports.financialPatterns = [
    exports.creditCardPatterns,
    exports.cvvPatterns,
    exports.bankAccountPatterns,
    exports.paymentPatterns,
    exports.taxIdPatterns,
];
//# sourceMappingURL=financial-patterns.js.map